#!/usr/bin/env python3
"""Hydrate checksum-pinned integration fixtures outside UPM package directories."""
...
def main() -> int:
    ...
    for fixture in files:
        ...
        cache_file = args.cache / f"{fixture_id}-{fixture['sha256']}.fixture"
        ...
        print(f"hydrated {target.relative_to(repository_root)}")
    return 0
