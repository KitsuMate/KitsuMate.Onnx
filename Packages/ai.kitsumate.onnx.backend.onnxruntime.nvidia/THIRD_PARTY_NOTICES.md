...
- ONNX Runtime 1.30.0 under the MIT license and its bundled third-party notices.
...
Release provisioning must retain the complete upstream license and acknowledgement files alongside the published UPM archive. See `Dependencies/onnxruntime-nvidia.lock.json` for exact origins and checksums.
