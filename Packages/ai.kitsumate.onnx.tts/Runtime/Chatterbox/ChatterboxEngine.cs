...
namespace KitsuMate.Onnx.Tts.Chatterbox
{
    ...
    public sealed class ChatterboxEngine : TtsEngine
    {
        ...
        protected override InferenceEngineRuntime<TtsRequest, TtsResult> CreateRuntime(ModelSet resolvedModelSet) => new ChatterboxEngineRuntime((ChatterboxModelSet)resolvedModelSet, voiceCacheCapacity, verboseLogging);
    }
}
